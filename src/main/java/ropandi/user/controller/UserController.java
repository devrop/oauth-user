...
public class UserController {
	...
	@GetMapping("loadByClientId")
	public ResponseEntity<ClientModel> loadByClientId(@RequestParam("clientId") String clientId){
		System.out.println("Call clientId " + clientId);
		ClientModel data = clientService.loadByClientId(clientId);
		if(data !=null){
			return new ResponseEntity<ClientModel>(data,HttpStatus.OK);
		}
		
		return new ResponseEntity<ClientModel>(data,HttpStatus.BAD_REQUEST);
